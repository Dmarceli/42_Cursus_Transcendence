...
<template>
	<div class="profile">
		...
		<div class="profile-header">
			...
			<font-awesome-icon class="settingsButton" :icon="['fas', 'gear']" style="color: #77767b;"
				@click="openSettings" />
		</div>
		<div class="profile-body">
			...
			<div class="game-history">
				...
				<table>
					<tbody>
						<tr v-for="game in lastGames.slice(-5)" :key="game.id"
							:class="{ 'game-won': game.userWon, 'game-lost': !game.userWon }">
							<td>
